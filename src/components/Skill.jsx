...
function Skill() {
  return (
    <div className="w-100 h-screen  bg-gray-800 text-gray-200 flex items-center justify-center flex-col">
      <div className="font-semibold text-3xl text-center animate-pulse">
        Skills
      </div>
      <div className='flex'>
      <Marquee pauseOnHover={true} speed={50}>
      <div className="container flex items-center justify-center flex-wrap ">
          <div className="flex flex-col  max-w-xs  justify-center rounded-sm items-center p-1 m-1">
            <AiFillHtml5 size={80} className='cursor-pointer'/>
